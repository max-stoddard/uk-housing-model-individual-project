...
from was.ComparisonStats import format_currency, to_std_dev_stats
from was.Distributions import (
...
from was.Plotting import apply_axis_grid, format_currency_axis
import WealthIncomeJointProbDist
...
def main() -> None:
    ...
    wave_min_net, wave_max_gross, wave_min_wealth, wave_max_wealth = (
        WealthIncomeJointProbDist.compute_income_wealth_bounds(WAVE_3_DATA)
    )
    round_min_net, round_max_gross, round_min_wealth, round_max_wealth = (
        WealthIncomeJointProbDist.compute_income_wealth_bounds(ROUND_8_DATA)
    )
    ...
    wave_outputs = WealthIncomeJointProbDist.run_wealth_income_joint_prob_dist(
        WAVE_3_DATA,
    ...
    round_outputs = WealthIncomeJointProbDist.run_wealth_income_joint_prob_dist(
        ROUND_8_DATA,
        income_bin_edges=shared_income_edges,
        wealth_bin_edges=shared_wealth_edges,
    )
