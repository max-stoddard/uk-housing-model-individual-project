...
from was.Plotting import apply_axis_grid, format_age_axis, format_currency_axis
import IncomeAgeJointProbDist
...
def main() -> None:
    ...
    wave_min_net, wave_max_gross = IncomeAgeJointProbDist.compute_income_bounds(
        WAVE_3_DATA
    )
    round_min_net, round_max_gross = IncomeAgeJointProbDist.compute_income_bounds(
        ROUND_8_DATA
    )
    ...
    wave_outputs = IncomeAgeJointProbDist.run_income_age_joint_prob_dist(
        WAVE_3_DATA,
    ...
    round_outputs = IncomeAgeJointProbDist.run_income_age_joint_prob_dist(
        ROUND_8_DATA,
        income_bin_edges=shared_income_edges,
    )
