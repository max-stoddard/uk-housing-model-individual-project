...
# Summary:
#   Run BUY* constrained quantile method search v2 on modern PSD/PPD data.
# Purpose:
#   Compare modern-realism variants (status and year policies) with guardrail diagnostics and overlays.
